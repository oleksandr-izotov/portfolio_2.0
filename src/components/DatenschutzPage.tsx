      ...
      <div className="max-w-3xl mx-auto px-6 pt-32 pb-24 relative z-10">
        ...
        <div className="space-y-8 text-[13px] font-mono text-zinc-400 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">{t.s2_text}</p>
            <p className="mb-1">{imp.name}</p>
            <p className="mb-1">{imp.city}</p>
            <p><a href={`mailto:${imp.email}`} className="hover:text-blue-400 transition-colors">{imp.email}</a></p>
          </section>
