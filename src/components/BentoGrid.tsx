...
const TimelineItem = ({ title, subtitle, date, type, current = false }: { title: string, subtitle: string, date: string, type: 'edu' | 'work', current?: boolean }) => (
  <div className="relative pl-8 pb-8 last:pb-0 group/time">
    <div className="absolute left-[11px] top-0 bottom-0 w-[1px] bg-gray-100 dark:bg-white/5 group-last/time:h-4" />
    <div className={`absolute left-0 top-1 w-6 h-6 rounded-full border-2 flex items-center justify-center z-10 transition-colors ${
      current 
      ...
      {type === 'edu' ? <GraduationCap size={12} /> : <Briefcase size={12} />}
    </div>
    <div className="transition-transform group-hover/time:translate-x-1 duration-300">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-1 mb-1">
        ...
        <span className="text-[10px] font-mono text-gray-400 dark:text-gray-500 uppercase tracking-widest bg-gray-50 dark:bg-white/5 px-2 py-0.5 rounded-full self-start">
          {date}
        </span>
      </div>
...
const ArchitectureBlueprint = () => {
  return (
    <div className="relative h-full min-h-[300px] w-full bg-gray-50 dark:bg-[#0c0c0e] overflow-hidden p-8 font-mono">
      {/* Grid Overlay */}
...
export const BentoGrid = () => {
  return (
    <section id="about" className="relative py-16 px-6 max-w-7xl mx-auto border-t border-gray-100 dark:border-white/5">
      ...
      <div className="mb-12">
        <div className="flex items-center gap-3 mb-4">
           ...
           <span className="text-[10px] font-mono font-bold uppercase tracking-[0.4em] text-blue-500">Core Foundation</span>
        </div>
        <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter dark:text-white leading-[0.85]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <BentoBox className="h-full">
            <div className="flex justify-between items-start mb-12">
               <div>
                  ...
                  <h2 className="text-3xl font-black uppercase tracking-tight dark:text-white leading-none">Education & Experience</h2>
               </div>
          ...
          <BentoBox className="h-full bg-blue-600 text-white border-blue-600 hover:border-white/50 dark:hover:border-blue-400/50">
            <div className="flex flex-col h-full">
              <div className="mb-8">
                ...
                <h3 className="text-2xl font-black uppercase tracking-tighter mt-2 leading-none">About Me</h3>
              </div>
              ...
              <div className="mt-12 pt-6 border-t border-white/10">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[10px] font-mono font-bold uppercase tracking-widest">System Architecture Enthusiast</span>
                </div>
              </div>
            </div>
          </BentoBox>
        ...
        <div className="lg:col-span-6">
           <BentoBox className="flex flex-col justify-between min-h-[180px]">
              <div className="w-12 h-12 bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center mb-6">
                 <Code2 className="text-blue-600 dark:text-blue-400" size={24} />
              </div>
              <div>
                 <p className="text-[10px] font-mono font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-2">Development Methodology</p>
                 <h4 className="text-xl font-black uppercase tracking-tight dark:text-white leading-tight">Agile, TDD & Clean Code Principles</h4>
              </div>
           </BentoBox>
        </div>
        ...
        <div className="lg:col-span-6">
           <BentoBox className="flex flex-col justify-between min-h-[180px]">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-6xl font-black text-blue-600 dark:text-blue-400 tracking-tighter">03+</span>
                <span className="text-[10px] font-mono font-black text-blue-600 uppercase tracking-widest animate-pulse">Years</span>
              </div>
              <div>
                 <p className="text-[10px] font-mono font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-2">Practical Experience</p>
                 <h4 className="text-xl font-black uppercase tracking-tight dark:text-white leading-tight">Years in Software Craft & Engineering</h4>
              </div>
           </BentoBox>
        </div>
